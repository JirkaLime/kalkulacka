# Calculator Project - Javascript Template

This repository contains template for **Calculator** project in Javascript.
...
Page can be run directly by opening `index.html`.
